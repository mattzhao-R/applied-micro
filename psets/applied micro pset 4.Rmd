...
We are able to fairly closely replicate the results from the paper in that the coefficient estimates for $\beta_1$ are relatively similar, with the standard errors somewhat different. Comparing the OLS and TSLS estimates, we see that the 
...
\hline \\[-1.8ex] 
 ...
 SMSA &  &  &  &  \\ 
  ...
  & & & & \\ 
\hline \\[-1.8ex] 
F Statistic & 14.85$^{***}$  & 14.85$^{***}$  & 336.30$^{***}$  & 371.35$^{***}$ \\ 
\hline 
\hline \\[-1.8ex] 
...
\hline \\[-1.8ex] 
 ...
 SMSA &  &  &  &  \\ 
  ...
  & & & & \\ 
\hline \\[-1.8ex] 
F Statistic & 27.90$^{***}$  & 27.21$^{***}$  & 333.62$^{***}$ (df = 43) & 398.38$^{***}$  \\ 
\hline 
\hline \\[-1.8ex] 
\textit{Note:}  & \multicolumn{4}{r}{$^{*}$p$<$0.1; $^{**}$p$<$0.05; $^{***}$p$<$0.01} \\ 
\end{tabular} 
...
\hline \\[-1.8ex] 
 ...
 SMSA &  &  &  &  \\ 
  ...
  & & & & \\ 
\hline \\[-1.8ex] 
F Statistic & 77.36$^{***}$  & 75.44$^{***}$  & 442.76$^{***}$ (df = 43) & 507.20$^{***}$  \\ 
\hline 
\hline \\[-1.8ex] 
\textit{Note:}  & \multicolumn{4}{r}{$^{*}$p$<$0.1; $^{**}$p$<$0.05; $^{***}$p$<$0.01} \\ 
\end{tabular} 
